            ...
            createLi: function() {
                ...
                return this.$element.find("option").each(function(b) {
                    ...
                    if (h++, !c.hasClass("bs-title-option")) {
                        ...
                        if (c.data("content") || (l = o + '<span class="text">' + l + n + "</span>"), "OPTGROUP" === this.parentNode.tagName && !0 !== c.data("divider")) {
                            var q = " " + this.parentNode.className || "";
                            if (0 === c.index()) {
                                f += 1;
                                var r = this.parentNode.label,
                                    s = void 0 !== c.parent().data("subtext") ? '<small class="text-muted">' + c.parent().data("subtext") + "</small>" : "";
                                r = (c.parent().data("icon") ? '<span class="' + d.options.iconBase + " " + c.parent().data("icon") + '"></span> ' : "") + '<span class="text">' + r + s + "</span>", 0 !== b && e.length > 0 && (h++, e.push(i("", null, "divider", f + "div"))), h++, e.push(i(r, null, "dropdown-header" + q, f))
                            }
...
! function(a, b) {
    ...
    Drupal.behaviors.ucdOneReplaceSVG = {
        attach: function() {
            if (!b.svg)
                for (var a = document.getElementsByTagName("img"), c = /.*\.svg$/, d = 0; d !== a.length; ++d) a[d].src.match(c) && (a[d].src = a[d].src.slice(0, -3) + "png")
        }
    }, Drupal.behaviors.ucdOnePlaceholder = {
        attach: function(c) {
            b.input.placeholder || a("[placeholder]", c).focus(function() {
                var b = a(this);
                b.val() === b.attr("placeholder") && b.removeClass("placeholder").val("")
            }).blur(function() {
                var b = a(this);
                "" === b.val() && b.addClass("placeholder").val(b.attr("placeholder"))
            }).blur()
        }
    }, Drupal.behaviors.ucdOneDeleteNode = {
        attach: function(b) {
            a(".pane-node-form-buttons #edit-delete", b).click(function(a) {
                confirm("Delete?! Are you sure you want to leave this page to delete everything?") || (a.preventDefault(), a.stopPropagation())
            })
        }
    }, Drupal.behaviors.ucdOneBootstrapSelect = {
        attach: function(b) {
            a("select", b).once().selectpicker()
        }
    }, Drupal.behaviors.ucdOnePanelsIPESiblingGrid = {
        attach: function(b) {
            a(".l-sibling-grid--half", b).once().each(function() {
                a(this).closest(".panels-ipe-portlet-wrapper").addClass("ipe-sibling-grid l-sibling-grid--half")
            }), a(".l-sibling-grid--third", b).once().each(function() {
                a(this).closest(".panels-ipe-portlet-wrapper").addClass("ipe-sibling-grid l-sibling-grid--third")
            })
        }
    }
}(jQuery, Modernizr),
function(a) {
    ...
    a(document).ready(function() {
        a(".anti-accordion__title").on("click", function(b) {
            b.preventDefault(), b.stopPropagation(), a(this).toggleClass("anti-accordion__title--open anti-accordion__title--closed").next().slideToggle(300)
        })
    })
}(jQuery),
function(a) {
    "use strict";
    a(document).ready(function() {
        var b = a(".collapse__title");
        a(".collapse__content").hide().removeClass("is-hidden--visually"), b.on("click", function(b) {
            b.preventDefault(), b.stopPropagation(), a(this).toggleClass("collapse__title--open collapse__title--closed").next().slideToggle(300)
        }), a(".list--faq > li:even").on("click", function(b) {
            b.preventDefault(), b.stopPropagation(), a(this).next().slideToggle(300)
        })
    })
}(jQuery),
function(a, b) {
    "use strict";
    !b.mq("(min-width: 480px)") && b.svg || a(document).ready(function() {
        var b = a(".hero-banner__video-placeholder"),
            c = b.data("hero-banner-video"),
            d = '<video class="hero-banner__video" width="1872" height="720" autoplay="true" loop="true" muted="true"><source src="' + c + '" type="video/mp4"></video>';
        b.append(d).removeClass("hero-banner__video-placeholder")
    })
}(jQuery, Modernizr),
function(a, b) {
    "use strict";
    a.isFunction(a.fn.masonry) && a(document).ready(function() {
        var c = a(".mason-grid");
        c.masonry({
        ...
        a(b).on("load resize", function() {
            d()
        }), b.chrome && setTimeout(d, 500)
    })
}(jQuery, window),
function(a) {
    "use strict";
    a(document).ready(function() {
        var b = a(".js-nav-toggle"),
            c = a(".l-navbar"),
            d = !1;
        b.click(function(a) {
            a.preventDefault(), a.stopPropagation(), b.toggleClass("nav-toggle--active"), c.toggleClass("menu--closed menu--open")
        }), a("body").on("focus", "a", function(e) {
            Modernizr.mq("(min-width: 992px)") || (a(e.target).closest(".l-navbar").length ? (d = !0, b.addClass("nav-toggle--active"), c.addClass("menu--open").removeClass("menu--closed")) : (d && -1 === this.className.indexOf("js-nav-toggle") && (c.removeClass("menu--open").addClass("menu--closed"), b.removeClass("nav-toggle--active")), d = !1))
        })
    })
}(jQuery),
function(a) {
    "use strict";
    a(document).ready(function() {
        a(".profile-highlight__body").on("click", function() {
            a(this).toggleClass("profile-highlight__body--showflip")
        })
    })
}(jQuery),
function(a, b) {
    ...
    a(document).ready(function() {
        var c = a(".primary-nav"),
            ...
            f = "(min-width: 992px)",
            g = !1,
            h = a("html").hasClass("lt-ie9"),
            i = function() {
                c.hoverIntent(function() {
                    clearTimeout(g), c.addClass("is-hover")
                }, function() {
            ...
            j = function() {
                Modernizr.mq(f) || h ? d.hasClass("is-horizontal") || (d.removeClass("is-vertical").addClass("is-horizontal"), c.find(".menu ul.menu").show(), c.find(".menu .menu ul.menu").hide(), i()) : d.hasClass("is-vertical") || (d.removeClass("is-horizontal").addClass("is-vertical"), c.find(".menu ul.menu").hide(), c.off("mouseenter mouseleave"), c.find(".submenu-toggle").removeClass("submenu-toggle--open"))
            };
        c.on("click", ".submenu-toggle", function(b) {
            b.preventDefault(), b.stopPropagation(), a(this).toggleClass("submenu-toggle--open").parent().next(".menu").slideToggle("fast")
        }), a(b).resize(function() {
            j()
        }), j()
    })
...
function(a) {
    ...
    a(document).ready(function() {
        var b = a(".quick-links"),
            c = a(".quick-links__title"),
            d = a(".quick-links__title .submenu-toggle"),
            e = a(".quick-links a"),
            f = "submenu-toggle--open",
            g = !1,
            h = null;
        a("body").on("touchstart click", function(c) {
            a(c.target).closest(".quick-links").length || Modernizr.mq("(min-width: 992px)") && (b.hide(), d.removeClass(f))
        }), c.on("focus", function(a) {
            h = a.currentTarget, b.slideDown("fast"), d.addClass(f)
        }).on("click", function(a) {
            a.preventDefault(), a.stopPropagation(), a.currentTarget !== h && (b.slideToggle("fast"), d.toggleClass(f)), h = null
        }), e.on("focus", function() {
            clearTimeout(g)
        }).on("focusout", function() {
            g = setTimeout(function() {
                b.hide(), d.removeClass(f)
            }, 100)
        }), a(window).resize(function() {
            b.hide(), d.removeClass(f)
        }), b.hide().removeClass("is-hidden--visually")
    })
}(jQuery),
function(a, b) {
    "use strict";
    a(document).ready(function() {
        var c = navigator.userAgent.match(/Mobi/) ? "false" : "true",
            d = function() {
                var b = a("<script/>", {
                    id: "iframe-api",
                    src: "//www.youtube.com/iframe_api"
                });
                a("script").first().before(b)
            },
            e = function(a, b) {
                a.hasClass("preloaded") || a.addClass("preloaded"), b.unMute(), b.playVideo()
            },
            f = function(a, b) {
                a.waypoint({
                    handler: function(c) {
                        "down" === c ? b.pauseVideo() : e(a, b)
                    },
                    offset: function() {
                    ...
                    handler: function(c) {
                        "down" === c ? e(a, b) : b.pauseVideo()
                    },
                    offset: function() {
                        return this.context.innerHeight() - this.element.clientHeight / 2
                    }
                })
            },
            g = function(a, b) {
                b.mute(), b.playVideo(), f(a, b)
            },
            h = function(a, b) {
                var c = b.getPlayerState();
                1 !== c || a.hasClass("preloaded") ? 0 === c && a.hasClass("preloaded") && b.playVideo() : (b.pauseVideo(), a.addClass("preloaded"))
            };
        b.onYouTubeIframeAPIReady = function() {
            a(".video-wrapper--youtube-api > div[data-youtubeid]").each(function() {
                var b, d = a(this).data("youtubeid");
                b = new YT.Player(this, {
                    height: "360",
                    width: "640",
                    videoId: d,
                    playerVars: {
...
function(a, b) {
    ...
    a(document).ready(function() {
        var c = a(".search-popup"),
            d = a(".js-search-popup__open"),
            e = a(".search-popup__close"),
            f = a(".search-popup__input");
        b.input.placeholder || c.addClass("search-popup--show-label"), d.on("click", function(a) {
            c.addClass("is-open"), f.focus(), a.preventDefault(), a.stopPropagation()
        }), e.on("click", function(a) {
            c.removeClass("is-open"), a.preventDefault(), a.stopPropagation()
        })
    })
}(jQuery, Modernizr),
function(a, b) {
    "use strict";
    a(document).ready(function() {
        var c = a(".search-popup__input");
        a(".search-popup__submit").on("click", function(d) {
            var e = a(this).val(),
                f = !1,
                g = c.val();
            "People" === e ? f = "//directory.ucdavis.edu/cgi-bin/directory_results.shtml?filter=" : "Departments" === e ? f = "//directory.ucdavis.edu/DeptListingSearchResults.htm?filter=" : "undefined" == typeof Drupal && (f = "//www.ucdavis.edu/search/google/"), f && (d.preventDefault(), d.stopPropagation(), g.length ? b.location.href = f + encodeURIComponent(g) : b.location.href = f)
        })
    })
}(jQuery, window),
function(a) {
    "use strict";
    a(document).ready(function() {
        var b = a(".l-header--fixed");
        a(window).scroll(function() {
            a(this).scrollTop() > 1 ? b.addClass("is-scrolling") : b.removeClass("is-scrolling")
        })
    })
}(jQuery),
function(a) {
